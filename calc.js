...
var author$project$Main$init = {k: 0, a: '0', h: true, i: elm$core$Maybe$Nothing, j: elm$core$Maybe$Nothing};
var author$project$Main$Add = 0;
var author$project$Main$Multiply = 0;
...
var author$project$Main$checkDivision = F3(
	function (op, divisor, model) {
		if (op === 1) {
			return (!divisor) ? _Utils_update(
...
var author$project$Main$checkOverflow = function (model) {
...
var author$project$Main$Equals = {$: 2};
...
var author$project$Main$Sum = function (a) {
	return {$: 1, a: a};
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('display-wrapper')
					]),
				_List_fromArray(
					[
						A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$Events$onClick(author$project$Main$Equals)
									]),
								_List_fromArray(
									[
										elm$html$Html$text('=')
