...
type alias Model =
  { display : String
  , productAccum : Maybe Float
  , accumulator : Float
  , prevOperator : Maybe Op
  , lastKeyWasOperator : Bool }
...
update msg model = 
  ...
  in case msg of
    ...
    Equals -> case .prevOperator model of
